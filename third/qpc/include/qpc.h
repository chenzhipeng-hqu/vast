...
/****************************************************************************/
#include <third/qpc/ports/qv/gnu/qf_port.h>      /* QF/C port from the port directory */
#include <third/qpc/include/qassert.h>      /* QP embedded systems-friendly assertions */

#ifdef Q_SPY /* software tracing enabled? */
    #include <third/qpc/ports/qv/gnu/qs_port.h>  /* QS/C port from the port directory */
#else
    #include <third/qpc/include/qs_dummy.h> /* QS/C dummy (inactive) interface */
#endif
