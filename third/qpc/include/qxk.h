...
#include <third/qpc/include/qequeue.h>  /* QXK kernel uses the native QP event queue  */
#include <third/qpc/include/qmpool.h>   /* QXK kernel uses the native QP memory pool  */
#include <third/qpc/include/qpset.h>    /* QXK kernel uses the native QP priority set */
