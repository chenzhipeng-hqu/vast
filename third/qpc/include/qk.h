...
#include <third/qpc/include/qequeue.h>  /* QK kernel uses the native QP event queue  */
#include <third/qpc/include/qmpool.h>   /* QK kernel uses the native QP memory pool  */
#include <third/qpc/include/qpset.h>    /* QK kernel uses the native QP priority set */
