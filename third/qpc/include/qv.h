...
#include <third/qpc/include/qequeue.h>  /* QV kernel uses the native QP event queue  */
#include <third/qpc/include/qmpool.h>   /* QV kernel uses the native QP memory pool  */
#include <third/qpc/include/qpset.h>    /* QV kernel uses the native QP priority set */
