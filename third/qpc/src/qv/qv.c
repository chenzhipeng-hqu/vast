...
#include <third/qpc/ports/qv/gnu/qf_port.h>      /* QF port */
#include <third/qpc/src/qf_pkg.h>       /* QF package-scope internal interface */
#include <third/qpc/include/qassert.h>      /* QP embedded systems-friendly assertions */
#ifdef Q_SPY              /* QS software tracing enabled? */
    #include <third/qpc/ports/qv/gnu/qs_port.h>  /* include QS port */
#else
    #include <third/qpc/include/qs_dummy.h> /* disable the QS software tracing */
#endif /* Q_SPY */
