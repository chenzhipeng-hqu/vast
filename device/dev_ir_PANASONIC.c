...
int InfraRed_RX_PANASONIC_Calculate(IR_TypeDef *pIR_Obj)
{
	...
	min0 = IR_PANASONIC_Zero[1].us * 0.8;
	max0 = IR_PANASONIC_Zero[1].us * 1.2;
	min1 = IR_PANASONIC_One[1].us * 0.8;
	max1 = IR_PANASONIC_One[1].us * 1.2;
	
	if(pIR_Obj->rx_len != 0)
	{
		for(idx=sizeof(IR_PANASONIC_Head)/sizeof(IR_PANASONIC_Head[0])+1; idx<pIR_Obj->rx_len; idx+=2)
		{			
